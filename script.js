...
const skillData = [['Python','cyan'],['TensorFlow','cyan'],['Keras','cyan'],['Scikit-learn','cyan'],['Pandas','cyan'],['NumPy','cyan'],['OpenCV','cyan'],['CNN','cyan'],['C++','orange'],['C','orange'],['SQL','orange'],['React','orange'],['Node.js','orange'],['MongoDB','orange'],['AWS','orange'],['ESP32','lime'],['Arduino','lime'],['Raspberry Pi','lime'],['MQTT','lime'],['I2C','lime'],['Embedded C','lime'],['PHP','orange']];
const skillContainer = document.querySelector('.skill-nodes');
const positions = [[5,22],[18,5],[37,1],[60,6],[79,22],[88,43],[80,67],[64,84],[42,91],[20,83],[4,66],[1,45],[18,39],[29,23],[48,16],[67,28],[71,51],[59,68],[38,75],[21,63],[28,47],[52,48]];
